...
### General information
Development of Charlène Hoareau's personal portfolio on his past achievements in web development, as part of the personal project "Portfolio Website" of the Codecademy.com online training: 
* Project planning.
...
`git clone https://github.com/charlella/MyPortfolio.git`
2. Open index.html file using local browser.

Live website : [MyPortfolio](https://charlella.github.io/MyPortfolio/)
